...
<head>
    ...
    <title>Add Student - Library Gateway System</title>
...
<body id="page-add-student" class="<?php echo $user_role; ?>">    
    ...
    <div id="container">
        <div class="wrap">
            ...
            <div class="clearfix">
                ...
                <div id="add-student-wrap" class="add-wrap">
                    <?php include('includes/add-student.inc.php'); ?>
                </div><!--/add-book-wrap-->
